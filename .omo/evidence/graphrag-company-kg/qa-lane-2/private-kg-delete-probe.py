...
marker='PRIVATE_KG_DELETE_MARKER_1782271351'
user=User.objects.create_user(email='qa_private_kg_1782271351@example.com', password='Passw0rd!qa')
company=Company.objects.create(company_name='QA Private KG 1782271351', industry='AI', roadmap_supported=True)
