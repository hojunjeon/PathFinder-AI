...
5. 각 항목은 작은 카테고리 설명이 아니라 개인 맞춤 면접 질문과 답변 팁 중심으로 작성하세요.
6. 학습 기준, 세부 근거, 출처 나열은 출력하지 말고 답변 방향에 필요한 힌트만 간결히 쓰세요.
7. 질문은 지원자의 실제 경험과 채용공고 요구사항을 자연스럽게 연결하도록 작성하세요.
    ...
    {{
      ...
      "subtopics": [
        {{
          ...
          "why": "",
          "question": "프로필·자기소개서·기업 정보·채용공고 기반 개인 맞춤 질문",
          "answer_guide": "답변 팁. 기업의 사용 맥락과 개인 경험을 어떻게 연결할지 간결히 포함",
          "evidence": "",
          "study_goal": "",
          "follow_up_questions": ["꼬리질문"]
        }}
